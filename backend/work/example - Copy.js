...
function onLocalTracks(tracks) {
    ...
    for (let i = 0; i < localTracks.length; i++) {
        ...
        console.error('local track video..................');
            $('body').append(`<video autoplay='1' id='localVideo${i}' />`);
            localTracks[i].attach($(`#localVideo${i}`)[0]);
        } else {
        console.error('local track audio..................');
            $('body').append(
...
function onRemoteTrack(track) {
    ...
    console.error('remote track ....                    '+track.getParticipantId());
    ...
    console.error('remote track video..................');
        $('body').append(
            `<video autoplay='1' id='${participant}video${idx}' />`);
    } else {
    console.error('remote track audio..................');
        $('body').append(
...
function onConferenceJoined() {
    console.error('conference joined!....................'+localTracks.length);
      ...
      // console.error('remote track muted                    '+track.getParticipantId());
      //  console.error('local track muted                    '+tracks.getParticipantId());
    isJoined = true;
    for (let i = 0; i < localTracks.length; i++) {
        room.addTrack(localTracks[i]);
    }
  /*  for (let i = 0; i < remoteTracks.length; i++) {
        room.addTrack(remoteTracks[i]);
    }*/
